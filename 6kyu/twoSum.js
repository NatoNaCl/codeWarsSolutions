...
(integers for the tests) and a target number. It should find two
different items in the array that, when added together, give the
target value. The indices of these items should then be returned in
...
//Output: array of indices of 2 integers that add up to target number
//Plan:
//iterate over array of numbers
//add each number to each other
//if 2 numbers add up to the target number, return their indices
