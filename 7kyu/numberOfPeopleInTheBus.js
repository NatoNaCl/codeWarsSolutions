...
the last bus station (after the last array). Even though it is the
last bus stop, the bus is not empty and some people are still in the
...
//Output: number of people on the bus
//Plan:
//declare value = 0
//iterate over array
//if integer pair is positive +1, else -1
//return total
