...
//Input: string/char, number and 2nd number
//Output: return result of number operation number
//Plan:
//check the operation for specific operators
//return result of performing the operator on value1 and value2
