...
Pipes list is correct when each pipe after the first index is greater
(+1) than the previous one, and that there is no duplicates.
...
//Output: array where numbers are sorted +1
//Plan:
//sort list from least to greatest
//iterate over each number, check if number + 1 equals next number
//if true, break else if false add to array
//return array
